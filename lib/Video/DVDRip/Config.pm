# $Id: Config.pm,v 1.53 2005/10/09 09:24:20 joern Exp $
...
my %CONFIG_PARAMETER = (
	...
	play_dvd_command => {
		...
		type  => 'string',
		value => 'mplayer <dvd://%t -aid %(%a+%b) -chapter %c -dvdangle %(%m+1) -dvd-device %d>',
		presets => [
...
sub save {
	...
	print $fh q{# $Id: Config.pm,v 1.53 2005/10/09 09:24:20 joern Exp $},"\n";
