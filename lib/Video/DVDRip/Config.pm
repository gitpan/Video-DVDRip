# $Id: Config.pm,v 1.17 2002/06/09 09:59:28 joern Exp $
...
my %CONFIG_PARAMETER = (
	...
	play_dvd_command => {
		...
		type  => 'string',
		value => 'mplayer <dvd://%t -aid 0x8%a -chapter %c -dvdangle %m>',
		presets => [
			'mplayer <dvd://%t -aid 0x8%a -chapter %c -dvdangle %m>',
...
sub save {
	...
	print $fh q{# $Id: Config.pm,v 1.17 2002/06/09 09:59:28 joern Exp $},"\n";
