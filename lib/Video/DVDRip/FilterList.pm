# $Id: FilterList.pm,v 1.11 2006/06/17 12:47:15 joern Exp $
...
sub save {
    ...
    print $fh q{# $Id: FilterList.pm,v 1.11 2006/06/17 12:47:15 joern Exp $},
        "\n";
    print $fh
...
sub new {
    ...
    my $in_config = Video::DVDRip::Base->version("transcode") >= 10100;
