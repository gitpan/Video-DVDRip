# $Id: ZoomCalculator.pm,v 1.16 2005/07/23 08:14:15 joern Exp $
		    ...
		    content => [
				...
				Gtk2::Ex::FormFactory::HBox->new (
					...
					Gtk2::Ex::FormFactory::Button->new (
					    label => __"Apply Clip & Zoom settings",
					    stock => "gtk-apply",
					    clicked_hook => sub {
					        $self->apply_values;
						1;
...
sub build_video_bitrate_calc {
	...
	my $video_bitrate_calc= $self->get_context
				     ->get_object("transcode")
...
sub build_zoom_calc_table {
	...
	return Gtk2::Ex::FormFactory::VBox->new (
		...
		Gtk2::Ex::FormFactory::List->new (
		    ...
		    columns        => [
			__"Result size", __"BPP", __"Eff. AR",
			__"AR error",    __"Clip1 (t/b/l/r)",
			__"Zoom size",   __"Clip2 (t/b/l/r)",
			"ar_perfect", "ar_ok",
		    ],
		    types	   => [
	    		("zoom_calc_text") x 7, "int", "int"
		    ],
...
sub apply_values {
	...
	$context->get_object("clip_zoom")->generate_preview_images;
